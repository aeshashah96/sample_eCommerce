            ...
            <div class="invoice">
                ...
                <div class="invoice-header">
                    ...
                    <div class="invoice-to">
                        <small>to</small>
                        <address class="m-t-5 m-b-5">
                            <strong class="text-inverse">Shipping Address</strong><br>
                            ...
                            <tbody>
                                @for ($i = 0; $i < count($totalItem); $i++)
                                    <tr>
                                        ...
                                        <td class="text-left">{{ $productVariantName[$i] }}</td>
                    ...
                    <div class="invoice-price">
                        ...
                        <div class="invoice-price-right">
                            <small>TOTAL</small> <span
                                class="f-w-600">{{ (int) $order->total_price + (int) $order->shipping_charge }}</span>
                        </div>
                    </div>
                    <!-- end invoice-price -->
                </div>
